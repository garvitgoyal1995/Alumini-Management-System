 ...
 <TABLE cellSpacing=0 cellPadding=0 width=775 align=center bgColor=#ffffff 
      ...
      document.write(TODAY);	</script></FONT></span><BR>
              ...
              <TR>
                ...
                <TD width=569 bgcolor="#D1C33C"><div align="right" class="style2"><jsp:include page="adminoptions.jsp"/> </div></TD>
                </TR>
              <TR>
				 ...
				 <jsp:include page="scroll.html"/> 
                  ...
                  <td width="412" valign="top">
                    <table width="200" border="0" align="center">
                  	...
                  	<table width="454" border="0" align="center" bordercolor="#655FE2" bgcolor="#D1C33C">
                      <tr>
                        <td width="143" bgcolor="#FF9428"><div align="center" class="style15">Company Name </div></td>
                        <td width="93" bgcolor="#FF9428"><div align="center" class="style15">Vacancy Position</div></td>
                        <td width="56" bgcolor="#FF9428"><div align="center" class="style15">Experience</div></td>
                        <td width="134" bgcolor="#FF9428"><div align="center" class="style15">Expiry Date</div></td>
                      </tr>
                      <%
                       ...
                       %>
                      <tr>
                        <td bgcolor="#FFD7AE"><a href="viewvacancydetails.jsp?vacancyid=<%=vacancyid%>" class="style12"><%=vacancydto.getCompanyname() %></a></td>
                        <td bgcolor="#FFD7AE"><span class="style12"><%=vacancydto.getVacancyposition() %></span></td>
                        <td bgcolor="#FFD7AE"><span class="style12"><%=vacancydto.getDesiredexp()%></span></td>
                        <td bgcolor="#FFD7AE"><span class="style12"><%=DateWrapper.parseDate(vacancydto.getExpirydate1())%></span></td>
                      </tr>
                      <%} %>
                    </table>
