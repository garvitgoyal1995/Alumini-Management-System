				 ...
				 <jsp:include page="scroll.html"/> 
                  ...
                  <td width="412" valign="top">
                    <table width="200" border="0" align="center">
                      ...
                      <tr>
                        <td width="143" bgcolor="#FF9428"><div align="center" class="style15">Event Name </div></td>
                        <td width="93" bgcolor="#FF9428"><div align="center" class="style15">Date</div></td>
                        <td width="56" bgcolor="#FF9428"><div align="center" class="style15">Venue</div></td>
                        <td width="134" bgcolor="#FF9428"><div align="center" class="style15">Status</div></td>
                      </tr>
                      <%
                       ...
                       %>
                      <tr>
                        <td bgcolor="#FFD7AE"><a href="vieweventdetails.jsp?eventid=<%=eventid%>" class="style12"><%=eventdto.getEventname() %></a></td>
                        <td bgcolor="#FFD7AE"><span class="style12"><%=DateWrapper.parseDate(eventdto.getEventdate1())%></span></td>
                        <td bgcolor="#FFD7AE"><span class="style12"><%=eventdto.getVenue()%></span></td>
                        <td bgcolor="#FFD7AE"><span class="style12"><%=eventdto.getStatus()%></span></td>
                      </tr>
                      <%} %>
                    </table>
