...
path="viewusereventdetails.jsp?eventid="+eventid
...
.style17 {color: #FF9428; font-weight: bold; }
</STYLE>
 ...
 <TABLE cellSpacing=0 cellPadding=0 width=775 align=center bgColor=#ffffff 
      ...
      document.write(TODAY);	</script></FONT></span><BR>
				 ...
				 <jsp:include page="scroll.html"/> 
                  ...
                  <td width="412" valign="top">
                    <table width="539" border="0" align="center">
                      <tr>
                        <td width="533"><div align="center" class="style25">
                   ...
                   %>
                            <table width="401" border="0" align="center">
                              ...
                              <tr>
                                ...
                                <td width="177" height="30"><span class="style17">To</span> 
             ...
             <table width="534" border="0" align="center" bordercolor="#655FE2" bgcolor="#D1C33C">
                      <tr>
                        <td width="149" bgcolor="#FF9428"><div align="center" class="style15">Event Name </div></td>
                        <td width="167" bgcolor="#FF9428"><div align="center" class="style15">Venue</div></td>
                        <td width="101" bgcolor="#FF9428"><div align="center" class="style15">Status</div></td>
                        <td width="101" bgcolor="#FF9428"><div align="center"><span class="style15">Date</span></div></td>
                      </tr>
                      ...
                      try{
                       ...
                       %>
                      <tr>
                        <td bgcolor="#FFD7AE"><p class="style12" onClick="showevent(<%=eventid%>)"><%=eventname %></p></td>
                        <td bgcolor="#FFD7AE"><span class="style12"><%=venue%></span></td>
                        <td bgcolor="#FFD7AE"><span class="style12"><%=status%></span></td>
                        <td bgcolor="#FFD7AE"><span class="style12"><%=date%></span></td>
                      </tr>
                      <%}}
