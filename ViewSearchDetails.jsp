...
<%@ page import="java.util.*,com.dts.aoc.dao.FriendDAO,com.dts.aoc.dto.FriendDTO,com.dts.aoc.dto.AcadamicDTO,com.dts.core.util.DateWrapper" %>
<HTML><HEAD>
<META 
				 ...
				 <jsp:include page="scroll.html"/> 
                  ...
                  <td width="412" valign="top">
                    <table width="200" border="0" align="center">
                      ...
                      <tr>
                        <td width="216" bgcolor="#FF9428"><div align="center" class="style15"> Name </div></td>
                        <td width="134" bgcolor="#FF9428"><div align="center" class="style15">Birth Date</div></td>
                        <td width="135" bgcolor="#FF9428"><div align="center" class="style15">Profession</div></td>
                        <%
                          if(session.getAttribute("user")!=null)
                          {
                         %>
                        <td width="56" bgcolor="#FF9428"><div align="center" class="style15"></div></td>
                        <%} %>
                      </tr>
                      <%
                         ...
                         String name=a[2];
      					 ArrayList al = new FriendDAO().search(acdto); 
